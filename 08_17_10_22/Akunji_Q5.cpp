/*Q5. WAP to add two object of disatance class overrload the greater than (>) operator to compare two object and return the object with larger
time value and display it.using comparison operator also.*/
